...
// 🔴 Wallet এবং FolderKanban আইকন যুক্ত করা হয়েছে
import { Search, Filter, Plus, Database, FileText, Tag as TagIcon, X, Loader2, AlertCircle, Wallet, FolderKanban } from 'lucide-react';
...
// 🔴 আপনার ফাইন্যান্স ড্যাশবোর্ডটি ইমপোর্ট করুন
...
export default function App() {
  ...
  // 🔴 নতুন স্টেট: ইউজার কি ডকুমেন্ট দেখছে নাকি ফাইন্যান্স ড্যাশবোর্ড? 🔴
    ...
    <div className="flex h-screen bg-slate-950 text-slate-300 overflow-hidden font-sans">
      ...
      <aside className="w-72 bg-slate-900 border-r border-slate-800 flex flex-col shrink-0 relative z-20 shadow-2xl">
        <div className="p-6">
          ...
          {/* 🔴 Main Menu (নতুন যুক্ত করা হয়েছে) 🔴 */}
          <div className="mb-8">
              ...
              {['All', ...CATEGORIES].map(category => (
                <button
                  ...
                  onClick={() => {
                    ...
                    setCurrentView('documents'); // ক্যাটাগরি সিলেক্ট করলে অটোমেটিক ডকুমেন্টে চলে যাবে
                  }}
                ...
                {allTags.map(tag => (
                  <button
                    ...
                    onClick={() => {
                      ...
                      setCurrentView('documents'); // ট্যাগ সিলেক্ট করলে ডকুমেন্টে চলে যাবে
                    }}
      ...
      <main className="flex-1 flex flex-col min-w-0 bg-slate-950/50 relative">
        ...
        {/* 🔴 কন্ডিশনাল রেন্ডারিং: currentView যদি documents হয় তবে আপনার আগের পেজ দেখাবে 🔴 */}
        {currentView === 'documents' ? (
          <>
            {/* Header */}
          ...
          /* 🔴 কন্ডিশনাল রেন্ডারিং: currentView যদি finance হয় তবে ফাইন্যান্স ড্যাশবোর্ড দেখাবে 🔴 */
